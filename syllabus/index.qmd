...
| 4 | 9/16 | Clock Configuration | Timers | [Lab 3](/lab/lab3/) |
| 5 | 9/23 | Interrupts | Serial Interfaces Overview & SPI | [Lab 4](/lab/lab4/) |
| 6 | 9/30 | TBD | TBD |  |
| 7 | 10/7 | Project Kickoff | UART and the IoT | [Lab 5](/lab/lab5/) |
| 8 | 10/14 | Happy Fall Break! **No Class** | Proposal Debriefs | [Project Proposal](/project/) |
| 9 | 10/21 | Advanced Encryption Standard (AES) | Graphics and Displays | [Lab 6](/lab/lab6/) |
| 10 | 10/28 | Motors and Speakers | Direct Memory Access | [Lab 7](/lab/lab7/) |
...
-   You must submit more than 10 reflections throughout the semester.
...
-   Messages sent on a weekday other than Friday (Monday-Thursday) before 4:00 pm PT will get a response the same day.
...
- Use spellchecking tools to help you write more effectively.
