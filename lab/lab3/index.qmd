...
Be sure to reuse substantial portions of your lab 2 design to reduce the total effort required for this lab. Notably, the keypad and LED hardware from lab2 can be helpful here, and the polling module, the seven-segment decoder, and the multiplexing logic can be reused in your Verilog.
