...
Test your system with the motor provided in the lab which spins at a known speed of approximately 2.5 rev/s when 12V are applied.
...
In Lab 6, you will learn how to use the UART peripheral to send binary data between devices, and print to the terminal embedded in Segger.
For this lab, you can follow [this tutorial](../../tutorials/tutorial-posts/printf-no-uart/index.qmd) on using `printf` without UART.

A datasheet for the motor is linked on the side of this page, but note that ours are slightly different: they have 408 pulse per rotation, and rotate at ~2.5 rev/s at 12V.
