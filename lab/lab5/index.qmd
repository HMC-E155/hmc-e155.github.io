...
In addition to the standard deliverables, your report should include a flowchart (see examples [here](https://users.ece.utexas.edu/~valvano/Volume1/E-Book/C12_Interrupts.htm)) showing each interrupt and the main loop that are executed. Test your system with the motor provided in the lab which spins at a known speed of approximately 10 rev/s.

::: {.callout-warning}
## Encoder Output Voltage Warning

The encoders used for this lab operate at a **5V** logic level. The STM32L432KC uses 3.3V, but has a few pins that are 5V tolerant. Make sure to use those pins or a voltage conversion circuit so you don't damage your board. 5V tolerant pins are tables 13-14 in the [STM32L432KC Datasheet](/assets/doc/ds11451-stm32l432kc.pdf)).
:::
