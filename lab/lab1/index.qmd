...
Next, launch Questa/ModelSim using the Simulation Wizard button as shown in the figure below

::: {#launch-questa}

![Button to launch Questa Simulation Wizard](images/simulation_wizard.png)
:::
