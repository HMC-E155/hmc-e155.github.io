...
To familiarize yourself with how to program the FPGA using Lattice Radiant, see the [Lattice Radiant iCE40 UltraPlus Project Setup](/tutorials/lattice-radiant-installation/) tutorial. 
