  ...
  html:
    other-links:
      ...
      - text: "Lattice Radiant Installation Tutorial"
        href: /tutorials/lattice-radiant-installation/
      - text: "Lattice Radiant iCE40 Project Setup"
        href: /tutorials/lattice-radiant-ice40-ultraplus-project-setup
...
To familiarize yourself with how to program the FPGA using Lattice Radiant, see the [Lattice Radiant iCE40 UltraPlus Project Setup](/tutorials/lattice-radiant-ice40-ultraplus-project-setup/) tutorial. 
...
Launch Lattice Radiant and start the New Project Wizard from the File or startup menu. Setup a new project for the UP5K chip following the instructions in the [Lattice Radiant Tutorial](/tutorials/lattice-radiant-ice40-ultraplus-project-setup/) on the E155 website.
...
If you're not seeing all the signals in your design, it's possible that QuestaSim optimized them away. To configure the optimization settings, see the relevant section in the [QuestaSim/ModelSim tutorial](/tutorials/modelsim-simulation-tutorial/#preventing-optimization).
:::
