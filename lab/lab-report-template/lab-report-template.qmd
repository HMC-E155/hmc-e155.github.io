...
::: {.callout-note title="Introduction" collapse="true"}
...
::: {.callout-note title="Design and Testing Methodology" collapse="true"}
...
::: {.callout-note title="Technical Documentation" collapse="true"}
...
::: {.callout-note title="Results and Discussion" collapse="true"}
...
::: {.callout-note title="Conclusion" collapse="true"}
