...
- [ ] Two seven-segment displays show two independent hexadecimal numbers.
...
- [ ] Scanning signal continues to be displayed under different keypress conditions, including multiple touches on rows or columns.
...
- [ ] Top design only includes instances of HSOSC, seven-segment module, counter module, scanning module and one-line assign statements. The assign statements should implement multiplexing and LED pass through.
...
- [ ] All counter modules (scanning and multiplexing) are parametrized instances of the counter module from lab 1. (Minor adjustments, especially to respond to instructor feedback, are allowed.  But any changes to the Verilog need to be verified by re-running the testbench.)

### Simulation Specifications

#### Proficiency

- [ ] No repeat simulations from lab 1. Those modules have already been verified! (But do include links to the lab 1 simulations in your report. Also, as above, include sims verifying modules that you changed.)
- [ ] QuestaSim simulations carried out (possibly manually) for the scanning module and the top module. 
- [ ] At least one simulation uses an automatic testbench.  (Lab 3 will require automatic testbenches for all modules.)
