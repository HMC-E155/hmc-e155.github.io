...
**UNDER CONSTRUCTION DO NOT BUY ANYTHING UNTIL THE INSTRUCTORS CONFIRM DETAILS**

If your team needs parts that are not available in the stockroom, you may spend up to \$50 to purchase them. 
You will need to save your receipts, fill out a reimbursement form available from the [department website](https://www.hmc.edu/engineering/current-student-information/department-forms/), and have an instructor approve the reimbursement (list your instructor as the faculty advisor on the form).
...
A 2-page proposal describing what you plan to build. It must be specific enough that we can tell when you demonstrate your project that it meets the specs of the proposal. 
Do not list stretch goals or wiggle words; simply state what you are committing to deliver. You may need to do some preliminary technical work to gain confidence you can deliver what you promise. The proposal must include the following:
...
* Include calculations of performance parameters that are important to the project (frame rates, data rates, ADC bits, Power levels, FFT sizes, etc.)
* Include a rough schedule and work breakdown.
...
Demonstrate a working project to an instructor in the lab.
...
If you realize your project is too large, contact us as soon as possible to renegotiate your project proposal. 
We will not accept revisions to the proposal after the Friday following the in-class presentation.
...
If you feel there has been inequality between the work you and your teammate deliver, contact an instructor personally.